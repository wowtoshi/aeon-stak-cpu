...
bool minethd::self_test()
{
	...
	if(jconf::inst()->HaveHardwareAes() && 0)
	{
		...
		unsigned char results[32*3];
		cryptonight_hash_ctx_np("The quick brown fox jumps over the lazy dogThe quick brown fox jumps over the lazy log", 43, results, ctx0);

		cryptonight_double_hash_ctx("The quick brown fox jumps over the lazy dogThe quick brown fox jumps over the lazy log", 43, out, ctx0, ctx1, ctx2, ctx3, ctx4);
		bResult &= memcmp(out, "\x3e\xbb\x7f\x9f\x7d\x27\x3d\x7c\x31\x8d\x86\x94\x77\x55\x0c\xc8\x00\xcf\xb1\x1b\x0c\xad\xb7\xff\xbd\xf6\xf8\x9f\x3a\x47\x1c\x59"
		                       ...
		                       "\xb4\x77\xd5\x02\xe4\xd8\x48\x7f\x42\xdf\xe3\x8e\xed\x73\x81\x7a\xda\x91\xb7\xe2\x63\xd2\x91\x71\xb6\x5c\x44\x3a\x01\x2a\x41\x22"
		                       "\xb4\x77\xd5\x02\xe4\xd8\x48\x7f\x42\xdf\xe3\x8e\xed\x73\x81\x7a\xda\x91\xb7\xe2\x63\xd2\x91\x71\xb6\x5c\x44\x3a\x01\x2a\x41\x22"
		                       "\xb4\x77\xd5\x02\xe4\xd8\x48\x7f\x42\xdf\xe3\x8e\xed\x73\x81\x7a\xda\x91\xb7\xe2\x63\xd2\x91\x71\xb6\x5c\x44\x3a\x01\x2a\x41\x22", 32*5) == 0;
	}
	else
	{
...
void minethd::double_work_main()
{
	...
	while (bQuit == 0)
	{
		...
		while (iGlobalJobNo.load(std::memory_order_relaxed) == iJobNo)
		{
			...
			*piNonce3 = ++iNonce;
			*piNonce4 = ++iNonce;
			cryptonight_double_hash_ctx(bDoubleWorkBlob, oWork.iWorkSize, bDoubleHashOut, ctx0, ctx1, ctx2, ctx3, ctx4);
