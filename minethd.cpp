...
bool minethd::self_test()
{
	...
	if(jconf::inst()->HaveHardwareAes() && 0)
	{
		...
		cryptonight_double_hash_ctx("The quick brown fox jumps over the lazy dogThe quick brown fox jumps over the lazy log", 43, out, ctx0, ctx1, ctx2, ctx3, ctx4, ctx4, ctx4, ctx4);
